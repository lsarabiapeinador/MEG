function cromatograma=grad2(L,alfa,ng,t,tmax)
...
% genera los límites de las mezclas del gradiente
[C1, C2]=limites(L,alfa);
C1=round(C1,4);
C2=round(C2,4);

% genera los tiempos del gradiente
Y1=gengrad(t,ng,1,tmax);



% calcula y dibuja un gradiente de C1 a C2
